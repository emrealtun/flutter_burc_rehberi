    ...
    return Card(
      ...
      child: Padding(
        ...
        child: ListTile(
          ...
          leading: Image.asset(
            "images/" + tumBurclar[index].burcKucukResim, width: 64, height: 64,),
          title: Text(tumBurclar[index].burcAdi, style: TextStyle(fontSize: 24,
              fontWeight: FontWeight.w400,
              color: Colors.pink.shade500),),
          subtitle: Padding(
            padding: const EdgeInsets.symmetric(vertical: 8),
            child: Text(tumBurclar[index].burcTarihi, style: TextStyle(
                fontSize: 18,
